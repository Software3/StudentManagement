function addFailed() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("tbody").append("<tr class='first'> <td> <input type='checkbox'> <a href='#' class='name'>" + term + "</a> </td> <td class='description'>" + subject + "</td> <td> <ul class='actions'> <li><a class='myEdit btn btn-info' onclick='editRow(this)' data-toggle='modal' href='#editModal'>编辑</a></li> <li class='last'><a onclick='deleteRow(this)' class='myDelete btn btn-danger' href='#'>删除</a></li> </ul> </td> </tr>");
        },
        error: function (xhr) {
